...
The System store is comprised of three separated databases: the Advert Store, Offer Store and the visit store and each of these are drawn together using a facade, much like a broker architecture, which will direct queries to the relevant database. \\
