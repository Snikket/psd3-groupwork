...
\begin{center}{
\begin{tabular}{|c|c|}
\hline \textbf{Meeting Plan}  &\textbf{Details}\\ 
\hline
\hline Day & Monday \\
\hline Time & 12:00\\
\hline Location & Boyd Orr Lab 720\\
\hline Attendees & List of Attendees\\
\hline Apologies & Read by Secretary\\
\hline Previous Minutes & Given by Secretary\\
\hline Current Agenda & List of tasks to be discussed\\
\hline Goals & Outcomes before next meeting\\
\hline Arrange next meeting & Next Monday or alternate day.\\
\hline
\end{tabular}}
\end{center}
